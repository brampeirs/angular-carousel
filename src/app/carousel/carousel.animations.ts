import {
  ...
  export const scaleOut = animation([
    animate('500ms cubic-bezier(0.785, 0.135, 0.15, 0.86)', style({ opacity: 0, transform: 'scale(0.5)' }))
  ]);
  ...
  export const flipIn = animation([
    animate(
      ...
      keyframes([
        style({ opacity: 1, transform: 'perspective(400px) rotate3d(1, 0, 0, 90deg)', offset: 0}), // start state
